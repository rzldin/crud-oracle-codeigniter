...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."ADMIN_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence ARTIKEL_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HR"."ARTIKEL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."KOMENTAR_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence TBLARTIKEL_ID_ARTIKEL_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HR"."TBLARTIKEL_ID_ARTIKEL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence USER_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HR"."USER_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."TBLADMIN" 
   (	"ID_ADMIN" NUMBER(11,0), 
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table TBLARTIKEL
--------------------------------------------------------

  CREATE TABLE "HR"."TBLARTIKEL" 
   (	"ID_ARTIKEL" NUMBER(11,0), 
	"ID_USER" NUMBER(11,0), 
	"GAMBAR" VARCHAR2(150 BYTE), 
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" 
 LOB ("ISI_ARTIKEL") STORE AS BASICFILE (
  TABLESPACE "USERS" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table TBLKOMENTAR
--------------------------------------------------------

  CREATE TABLE "HR"."TBLKOMENTAR" 
   (	"ID_KOMENTAR" NUMBER(11,0), 
	"ID_USER" NUMBER(11,0), 
	"ID_ARTIKEL" NUMBER(11,0), 
	"ISI_KOMENTAR" CLOB, 
	"TANGGAL" DATE
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" 
 LOB ("ISI_KOMENTAR") STORE AS BASICFILE (
  TABLESPACE "USERS" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."TBLUSER" 
   (	"ID_USER" NUMBER(11,0), 
	"NAMA_USER" VARCHAR2(100 BYTE), 
	"EMAIL" VARCHAR2(150 BYTE), 
	"PASSWORD" VARCHAR2(150 BYTE), 
	"STATUS" NUMBER(11,0)
   ) SEGMENT CREATION IMMEDIATE 
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table TBL_COBA
--------------------------------------------------------

  CREATE TABLE "HR"."TBL_COBA" 
   (	"ID" NUMBER(12,0), 
	"KET" VARCHAR2(25 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
SET DEFINE OFF;
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('100','Steven','King','SKING','515.123.4567',to_date('17-06-2003','DD-MM-RRRR'),'AD_PRES','24000',null,null,'90');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('101','Neena','Kochhar','NKOCHHAR','515.123.4568',to_date('21-09-2005','DD-MM-RRRR'),'AD_VP','17000',null,'100','90');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('102','Lex','De Haan','LDEHAAN','515.123.4569',to_date('13-01-2001','DD-MM-RRRR'),'AD_VP','17000',null,'100','90');
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('105','David','Austin','DAUSTIN','590.423.4569',to_date('25-06-2005','DD-MM-RRRR'),'IT_PROG','4800',null,'103','60');
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('108','Nancy','Greenberg','NGREENBE','515.124.4569',to_date('17-08-2002','DD-MM-RRRR'),'FI_MGR','12008',null,'101','100');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('109','Daniel','Faviet','DFAVIET','515.124.4169',to_date('16-08-2002','DD-MM-RRRR'),'FI_ACCOUNT','9000',null,'108','100');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('110','John','Chen','JCHEN','515.124.4269',to_date('28-09-2005','DD-MM-RRRR'),'FI_ACCOUNT','8200',null,'108','100');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('111','Ismael','Sciarra','ISCIARRA','515.124.4369',to_date('30-09-2005','DD-MM-RRRR'),'FI_ACCOUNT','7700',null,'108','100');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('112','Jose Manuel','Urman','JMURMAN','515.124.4469',to_date('07-03-2006','DD-MM-RRRR'),'FI_ACCOUNT','7800',null,'108','100');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('113','Luis','Popp','LPOPP','515.124.4567',to_date('07-12-2007','DD-MM-RRRR'),'FI_ACCOUNT','6900',null,'108','100');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('114','Den','Raphaely','DRAPHEAL','515.127.4561',to_date('07-12-2002','DD-MM-RRRR'),'PU_MAN','11000',null,'100','30');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('115','Alexander','Khoo','AKHOO','515.127.4562',to_date('18-05-2003','DD-MM-RRRR'),'PU_CLERK','3100',null,'114','30');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('116','Shelli','Baida','SBAIDA','515.127.4563',to_date('24-12-2005','DD-MM-RRRR'),'PU_CLERK','2900',null,'114','30');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('117','Sigal','Tobias','STOBIAS','515.127.4564',to_date('24-07-2005','DD-MM-RRRR'),'PU_CLERK','2800',null,'114','30');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('118','Guy','Himuro','GHIMURO','515.127.4565',to_date('15-11-2006','DD-MM-RRRR'),'PU_CLERK','2600',null,'114','30');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('119','Karen','Colmenares','KCOLMENA','515.127.4566',to_date('10-08-2007','DD-MM-RRRR'),'PU_CLERK','2500',null,'114','30');
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('125','Julia','Nayer','JNAYER','650.124.1214',to_date('16-07-2005','DD-MM-RRRR'),'ST_CLERK','3200',null,'120','50');
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('131','James','Marlow','JAMRLOW','650.124.7234',to_date('16-02-2005','DD-MM-RRRR'),'ST_CLERK','2500',null,'121','50');
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('132','TJ','Olson','TJOLSON','650.124.8234',to_date('10-04-2007','DD-MM-RRRR'),'ST_CLERK','2100',null,'121','50');
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('151','David','Bernstein','DBERNSTE','011.44.1344.345268',to_date('24-03-2005','DD-MM-RRRR'),'SA_REP','9500','0,25','145','80');
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('202','Pat','Fay','PFAY','603.123.6666',to_date('17-08-2005','DD-MM-RRRR'),'MK_REP','6000',null,'201','20');
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('204','Hermann','Baer','HBAER','515.123.8888',to_date('07-06-2002','DD-MM-RRRR'),'PR_REP','10000',null,'101','70');
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('206','William','Gietz','WGIETZ','515.123.8181',to_date('07-06-2002','DD-MM-RRRR'),'AC_ACCOUNT','8300',null,'205','110');
...
SET DEFINE OFF;
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('102',to_date('13-01-2001','DD-MM-RRRR'),to_date('24-07-2006','DD-MM-RRRR'),'IT_PROG','60');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('101',to_date('21-09-1997','DD-MM-RRRR'),to_date('27-10-2001','DD-MM-RRRR'),'AC_ACCOUNT','110');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('101',to_date('28-10-2001','DD-MM-RRRR'),to_date('15-03-2005','DD-MM-RRRR'),'AC_MGR','110');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('201',to_date('17-02-2004','DD-MM-RRRR'),to_date('19-12-2007','DD-MM-RRRR'),'MK_REP','20');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('114',to_date('24-03-2006','DD-MM-RRRR'),to_date('31-12-2007','DD-MM-RRRR'),'ST_CLERK','50');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('122',to_date('01-01-2007','DD-MM-RRRR'),to_date('31-12-2007','DD-MM-RRRR'),'ST_CLERK','50');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('200',to_date('17-09-1995','DD-MM-RRRR'),to_date('17-06-2001','DD-MM-RRRR'),'AD_ASST','90');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('176',to_date('24-03-2006','DD-MM-RRRR'),to_date('31-12-2006','DD-MM-RRRR'),'SA_REP','80');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('176',to_date('01-01-2007','DD-MM-RRRR'),to_date('31-12-2007','DD-MM-RRRR'),'SA_MAN','80');
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('200',to_date('01-07-2002','DD-MM-RRRR'),to_date('31-12-2006','DD-MM-RRRR'),'AC_ACCOUNT','90');
...
REM INSERTING into HR.TBLADMIN
SET DEFINE OFF;
Insert into HR.TBLADMIN (ID_ADMIN,NAMA_ADMIN,EMAIL,PASSWORD,AKSES) values ('3','admin','admin@forum.com','$2y$10$C3TiM4kYtAJ35HGrqBXnhuEM1pxjAcF/4/IojEbwyCbGFgAzXouLa','1');
REM INSERTING into HR.TBLARTIKEL
SET DEFINE OFF;
Insert into HR.TBLARTIKEL (ID_ARTIKEL,ID_USER,GAMBAR,JUDUL,TANGGAL,STATUS) values ('1','1','WhatsApp_Image_2020-12-06_at_22_33_07.jpeg','Coba',to_date('07-12-2020','DD-MM-RRRR'),'1');
REM INSERTING into HR.TBLKOMENTAR
SET DEFINE OFF;
Insert into HR.TBLKOMENTAR (ID_KOMENTAR,ID_USER,ID_ARTIKEL,TANGGAL) values ('1','1','1',to_date('07-12-2020','DD-MM-RRRR'));
REM INSERTING into HR.TBLUSER
SET DEFINE OFF;
Insert into HR.TBLUSER (ID_USER,NAMA_USER,EMAIL,PASSWORD,STATUS) values ('1','raldin','rald@gmail.com','$2y$10$dbQJSQ69UFgk7VKjdyoQLeJyjkMywLx9ELXAIebQrZAdIuRomZr0u','1');
REM INSERTING into HR.TBL_COBA
SET DEFINE OFF;
Insert into HR.TBL_COBA (ID,KET) values ('1','test');
--------------------------------------------------------
--  DDL for Index PK_ARTIKEL
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."PK_ARTIKEL" ON "HR"."TBLARTIKEL" ("ID_ARTIKEL") 
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index PK_KOMENTAR
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."PK_KOMENTAR" ON "HR"."TBLKOMENTAR" ("ID_KOMENTAR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."PK_USER" ON "HR"."TBLUSER" ("ID_USER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."PK_ADMIN" ON "HR"."TBLADMIN" ("ID_ADMIN") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Trigger AUTO_ADMIN_ID
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HR"."AUTO_ADMIN_ID" 
...
/
ALTER TRIGGER "HR"."AUTO_ADMIN_ID" ENABLE;
--------------------------------------------------------
--  DDL for Trigger AUTO_ARTIKEL_ID
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HR"."AUTO_ARTIKEL_ID" 
...
END;
/
ALTER TRIGGER "HR"."AUTO_ARTIKEL_ID" ENABLE;
--------------------------------------------------------
--  DDL for Trigger AUTO_KOMENTAR_ID
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HR"."AUTO_KOMENTAR_ID" 
...
END;
/
ALTER TRIGGER "HR"."AUTO_KOMENTAR_ID" ENABLE;
--------------------------------------------------------
--  DDL for Trigger AUTO_USER_ID
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HR"."AUTO_USER_ID" 
...
END;
/
ALTER TRIGGER "HR"."AUTO_USER_ID" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table TBLKOMENTAR
--------------------------------------------------------

  ALTER TABLE "HR"."TBLKOMENTAR" ADD CONSTRAINT "PK_KOMENTAR" PRIMARY KEY ("ID_KOMENTAR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."TBLKOMENTAR" MODIFY ("TANGGAL" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLKOMENTAR" MODIFY ("ISI_KOMENTAR" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLKOMENTAR" MODIFY ("ID_ARTIKEL" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLKOMENTAR" MODIFY ("ID_USER" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLKOMENTAR" MODIFY ("ID_KOMENTAR" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table TBLADMIN
--------------------------------------------------------

  ALTER TABLE "HR"."TBLADMIN" ADD CONSTRAINT "PK_ADMIN" PRIMARY KEY ("ID_ADMIN")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."TBLADMIN" MODIFY ("AKSES" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLADMIN" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLADMIN" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLADMIN" MODIFY ("NAMA_ADMIN" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLADMIN" MODIFY ("ID_ADMIN" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table TBLUSER
--------------------------------------------------------

  ALTER TABLE "HR"."TBLUSER" ADD CONSTRAINT "PK_USER" PRIMARY KEY ("ID_USER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."TBLUSER" MODIFY ("STATUS" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLUSER" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLUSER" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLUSER" MODIFY ("NAMA_USER" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLUSER" MODIFY ("ID_USER" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table TBLARTIKEL
--------------------------------------------------------

  ALTER TABLE "HR"."TBLARTIKEL" ADD CONSTRAINT "PK_ARTIKEL" PRIMARY KEY ("ID_ARTIKEL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."TBLARTIKEL" MODIFY ("STATUS" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLARTIKEL" MODIFY ("TANGGAL" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLARTIKEL" MODIFY ("ISI_ARTIKEL" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLARTIKEL" MODIFY ("JUDUL" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLARTIKEL" MODIFY ("ID_USER" NOT NULL ENABLE);
  ALTER TABLE "HR"."TBLARTIKEL" MODIFY ("ID_ARTIKEL" NOT NULL ENABLE);
--------------------------------------------------------
